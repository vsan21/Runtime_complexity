...
//Time is O(n^2), Space is O(1) - just duplicated
...
//Time and Space both O(n) - duplicates and seen --> THIS WOULD BE THE FASTEST (Set/has > Array/indexOf)
...
//Time is O(n log n) b/c of array.sort(). Space is O(1) - just duplicates
...
//Time and Space both: O(n) - duplicated and seen (Array/indexOf < Set/has)
...
//Time and Space are both O(n) - previousItem and itemCount
...
//Time is O(n), but Space is O(1) - just counts --> THIS WOULD BE THE FASTEST
